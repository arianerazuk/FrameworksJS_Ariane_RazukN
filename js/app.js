//Variables
	...
	var juegoDulces = {
		...
		Columnas: function(){
		  ...
		  resetDiv: function(){
		    setTimeout(function(){
		      var col = new juegoDulces.Columnas;
		      var num = 1;
		      var numImg = 1;
		  ...
		  animacionAcertar: function(){
		    ...
		    if(data.length != 0){
		      for(var i = 0; i < data.length; i++){
		        switch(data[i].obj){
		          case "Col":
		            objeto = new this.Columnas;
		            break;
		          case "Fil":
		            objeto = new this.Filas;
		            break;
		          default:
		  ...
		  scanRepetidosCol: function(){
		    var imagen = new this.imagenes;
		    var colDiv = new this.Columnas;
		    var col = new this.Columnas;
		    var objeto = "Col";
		    ...
		    for(var i = 0; i < col.total; i++){
		      for(var img = 0; img < imagen.total; img++){
		        if($(col[i][0]).attr("src") == imagen[img] && $(col[i][1]).attr("src") == imagen[img] && $(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img] && $(col[i][6]).attr("src") ==imagen[img]){
		          ...
		          data.push(item);
		          //this.animacionAcertar([0,1,2,3,4,5,6], colDiv[i], objeto, i, puntuacion);
		          ...
		          data.push(item);
		          //this.animacionAcertar([1,2,3,4,5,6], colDiv[i], objeto, i, puntuacion);
		          ...
		          data.push(item);
		          //this.animacionAcertar([0,1,2,3,4,5], colDiv[i], objeto, i, puntuacion);
		          ...
		          data.push(item);
		          //this.animacionAcertar([1,2,3,4,5], colDiv[i], objeto, i, puntuacion);
		          ...
		          data.push(item);
		          //this.animacionAcertar([2,3,4,5], colDiv[i], objeto, i, puntuacion);
		          ...
		          data.push(item);
		          //this.animacionAcertar([3,4,5,6], colDiv[i], objeto, i, puntuacion);
		          ...
		          data.push(item);
		          //this.animacionAcertar([3,4,5], colDiv[i], objeto, i, puntuacion);
		          ...
		          data.push(item);
		          //this.animacionAcertar([4,5,6], colDiv[i], objeto, i, puntuacion);
		  ...
		  scanRepetidosFil: function(){
		    var imagen = new this.imagenes;
		    var filDiv = new this.Filas;
		    var fil = new this.Filas;
		    var objeto = "Fil";
